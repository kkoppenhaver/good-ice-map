<nav x-data="{ open: false }" class="bg-white border-b-5 border-black">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 text-sm leading-4 font-bold uppercase text-black bg-white hover:text-primary-600 focus:outline-none transition ease-in-out duration-150">
