                            ...
                            <div class="p-4">
                                ...
                                <div class="flex items-center justify-between mb-4">
                                    @if ($location->average_rating)
                                        <span class="flex items-center font-bold text-primary-600">
                                            <svg viewBox="0 0 24 24" class="w-5 h-5 me-1" stroke="black" stroke-width="2" stroke-linejoin="round">
                                                <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" fill="black"/>
                                            </svg>
